...
// Estados de juego
// 0=Menú principal, 1=SelecNivel, 2=IngresaNombre, 3=Jugando, 4=Fin (tiempo),
// 5=VerResultados, 6=Cargando, 7=Instrucciones
int gameState = 0;  
String playerName = "";  
...
// Pantalla "Cargando"
int loadingStart = 0; 
int loadingDelay = 5000;  // 5s de pantalla "Cargando"
...
void draw() {
  // Si estamos jugando (gameState 3) usamos el fondo oscuro, sino el azul claro
  if (gameState == 3) {
    background(50);
  } else {
